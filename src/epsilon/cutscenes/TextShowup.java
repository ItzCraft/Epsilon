...
public class TextShowup extends CutsceneBase{
    ...
    public void begin(){
        ...
        table.bottom().table(Styles.black5, t -> t.margin(10f).add(Core.bundle.get(text)).style(Styles.outlineLabel)).padRight(65f).padBottom(70f).size(Core.bundle.get(text).length() * 9f, 60f);
