...
public class TextShowup extends CutsceneBase{
    ...
    public void begin(){
        ...
        table.bottom().table(Styles.black5, t -> t.margin(1).image(Core.atlas.find(unitIconName + "-full")).style(Styles.outlineLabel)).padLeft(-15f).padBottom(70f).size(65f, 80f);
